//empty api request should cause an error 406 Not Acceptable
//
//
//wrong request length shoud cause an error 406 Not Acceptable
//
//Post method is disabled by default and should cause an error 403 
//
//
/* eslint-env mocha */
